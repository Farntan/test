...
<div class="input-group mb-3" id="passport_date">
  ...
  <input type="text" class="form-control me-2" placeholder="серия XX XX"  name="series" value="'.$application->passport_series.'"
         aria-label="серия XX XX" required minlength="4" maxlength="5" required '.$element_availability.'>
  <input type="text" class="form-control me-2" placeholder="номер XXXXXX"  value="'.$application->passport_number.'"
  ...
  <input type="date" class="form-control" placeholder="дата выдачи"  name="date_issue" value="'.$application->passport_data.'"
